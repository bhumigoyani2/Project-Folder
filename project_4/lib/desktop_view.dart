...
class _DesktopViewState extends State<DesktopView> {
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: commonContainer_1(context,
  ...
  Container commonContainer(BuildContext context,
  ...
  Container commonContainer_1(BuildContext context,
      {String? text1,
      String? text2,
      String? text3,
      String? image,
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Image.network("$img2", height: 100, width: 150, fit: BoxFit.fill),
              const SizedBox(
                width: 5,
              ),
              Image.network("$img3", height: 100, width: 150, fit: BoxFit.fill),
              const SizedBox(
                width: 5,
              ),
              Image.network("$img4", height: 100, width: 80, fit: BoxFit.cover),
            ],
          )
        ],
      ),
